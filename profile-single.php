		...
		echo '<div class="profile_sidebar">';
			...
			if ($profile_details == 'true') {
				...
				echo '<div class="profile_details entry-meta">';
					...
					theater_get_profile_features('details', $cmsmasters_profile_features, false, 'h3', true);
			...
			theater_get_profile_features('features', $cmsmasters_profile_features_one, $cmsmasters_profile_features_one_title, 'h5', true);
			
			theater_get_profile_features('features', $cmsmasters_profile_features_two, $cmsmasters_profile_features_two_title, 'h5', true);
			
			theater_get_profile_features('features', $cmsmasters_profile_features_three, $cmsmasters_profile_features_three_title, 'h5', true);
...
if ($cmsmasters_option['theater' . '_profile_post_nav_box']) {
	...
	theater_prev_next_posts($order_cat);
}
